"""R4-d2/d3a: edge residual flow and factorized source in free rollout."""
...
evolution_magnitude_huber_beta = 0.05
evolution_state_huber_beta = 1.0
evolution_regime_loss_weight = 1.0
evolution_magnitude_loss_weight = 1.0
evolution_state_loss_weight = 0.2

evolution_free_rollout_training = True
evolution_rollout_loss_weight = 1.0
evolution_use_edge_residual_flow = True
evolution_edge_flow_max_displacement = 0.25
evolution_edge_huber_beta = 1.0
evolution_edge_loss_weight = 0.2
evolution_edge_smooth_weight = 0.01

bth_mechanism_checkpoint_monitor = 'val_loss'
bth_mechanism_checkpoint_mode = 'min'
...
evolution_source_checkpoint = (
    'work_dirs/bth_r4d1b_factorized_capacity_s1_20ep_seed0/'
    'checkpoints/best_val_mechanism.ckpt'
)
