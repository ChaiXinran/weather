"""R4-d1b: factorized source with advected-intensity capacity bins."""
...
# Replace with Train-only oracle positive-source P95/P99 from R4-d0.
...
bth_mechanism_checkpoint_monitor = 'val_tf_loss'
